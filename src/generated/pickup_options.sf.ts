...
export interface components {
  schemas: {
    PickupRequestPayload: {
      searchArea?: components["schemas"]["SearchArea"];
    ...
    PickupOptionsResponse: {
      ...
      pickupOptions?: components["schemas"]["PickupOption"][];
    };
    PickupOption: {
      pickupMethod?: components["schemas"]["PickupMethod"];
      /** @description Items that are available using the pickup method. */
      availableItems?: components["schemas"]["AvailableItem"][];
    };
  ...
  "post-pickup-options": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            results?: components["schemas"]["PickupOptionsResponse"][];
          };
        };
      };
    };
